...
NotifyLib.prompt('Rainbow Sunshine', 'Modified & Created By: LucLucas on YT', 5)
...
if isTouchEnabled then
    ...
    NotifyLib.prompt('Mobile Device Detected', 'Loading C Tool..', 5)
    ...
    NotifyLib.prompt('Mobile C Tool', 'C Tool Has Successfully Loaded!', 5)
...
elseif isGamepadEnabled and isTouchEnabled then
    ...
    NotifyLib.prompt('Controller And Mobile Device Detected', 'Loading C Tool..', 5)
    ...
    NotifyLib.prompt('Controller And Mobile C Tool', 'C Tool Has Successfully Loaded!', 5)
...
elseif isMouseEnabled and isMouseEnabled and isTouchEnabled then
    ...
    NotifyLib.prompt('Hybird Mobile C Tool', 'C Tool Has Successfully Loaded!', 5)
end

Settings = {   
    rewrittenmain = {
		Enabled = true,
		Key = "C", -- change the key
		DOT = true,
		AIRSHOT = true,
        NOTIF = true,			
        AUTOPRED = true,			
...
NotifyLib.prompt('LuaLucas', 'Loaded Rainbow Sunshine!', 5)
